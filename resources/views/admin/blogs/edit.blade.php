...
@section('title', __('keywords.edit_blog'))
@section('content')
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <h5 class="page-title">{{ __('keywords.edit_blog') }}</h5>
              ...
              <form action="{{ route('admin.blogs.update',['blog'=> $blog]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="{{ __('keywords.name') }}" value="{{ $blog->name }}">
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <textarea name="description" class="form-control" placeholder="{{ __('keywords.description') }}" >{{ $blog->description }} </textarea>
