...
<div class="dashboard-home">
  ...
  <div class="stats-cards" style="display: flex; gap: 20px; flex-wrap: wrap; margin-top: 20px;">
      <div class="card" style="background: #f5f5f5; padding: 20px; border-radius: 10px; flex: 1;">
          <h4>Services</h4>
          <p>3</p>
      </div>
      <div class="card" style="background: #f5f5f5; padding: 20px; border-radius: 10px; flex: 1;">
  ...
  <div class="recent-box" style="margin-top: 60px;">
      <h3>Recent Activity</h3>
      <ul style="list-style: none; padding: 0;">
          <li>✔️ User registered: Hesham Mahmoud</li>
          <li>📩 Message received from: hisham123seada@gmail.com</li>
